...
namespace GAM.Data.Migrations
{
    ...
    [Migration("20171119220406_AddedPedidoGametasViewModel")]
    partial class AddedPedidoGametasViewModel
    {
            ...
            modelBuilder.Entity("GAM.Models.Laboratorio.Amostra", b =>
                {
                    ...
                    b.Property<int>("GlobetCor");

                    b.Property<int>("GlobetNumero");

                    b.Property<int>("PalhetaCor");
            ...
            modelBuilder.Entity("GAM.Models.Questionarios.Resposta", b =>
                {
                    b.HasOne("GAM.Models.DadorViewModels.Dador", "Dador")
                        .WithOne("Resposta")
                        .HasForeignKey("GAM.Models.Questionarios.Resposta", "DadorId")
                        .OnDelete(DeleteBehavior.Cascade);
